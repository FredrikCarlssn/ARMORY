            ...
            <Content>
              <div className="relative flex flex-col items-center py-24">
                <div className="mr-64 w-7/12">
                  ...
                  <p className="">
                    ...
                    energy in the world. The Nexus is a recurring global event
                    in the game that acts as a seasonal reset, wiping the
                    possessions and memories of all characters. Only the
                  ...
                  <>
                    ...
                    >
                      ...
                      <p>
                        ...
                        sealed items offer their holders the power of trade in
                        the bustling open market. Venture into the heart of the
                        artisan shop, where items are imbued with newfound
                        power, enhancing their quality and rarity, unlocking
                        hidden modifications and amplifying their stats,
                        unveiling untold power in the mystical world. Manipulate
                        the essence of your weapon, rerolling and appending
                        affixes, to morph its abilities and shape your destiny
                        in the realms.
                      </p>
                    </motion.div>
                    <motion.img
              ...
              <Game>
                ...
                <div className="ml-8 text-lg">
                  <h1 className="text-4xl ml-8 mb-4 font-bold">
                    About the game
                  </h1>
                  <p className="mx-4">
                    ...
                    experience, a well-crafted barter economy, and characters
                    with unique skills and talents. Ensuring high
                    re-playability, the game utilizes seasonal rest, introducing
                    new content to its players.
                  </p>
                </div>
              </Game>
            </Content>
